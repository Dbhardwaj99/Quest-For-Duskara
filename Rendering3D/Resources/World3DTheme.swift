...
struct WorldPalette {
    ...
    var earth = c(0.36, 0.40, 0.32)
    var skirt = c(0.28, 0.28, 0.26)
    ...
    static let desert: WorldPalette = {
        ...
        p.earth = c(0.62, 0.52, 0.38)
        p.skirt = c(0.48, 0.38, 0.28)
    ...
    static let mountains: WorldPalette = {
        ...
        p.earth = c(0.42, 0.44, 0.44)
        p.skirt = c(0.32, 0.33, 0.34)
    ...
    static let forest: WorldPalette = {
        ...
        p.earth = c(0.28, 0.33, 0.26)
        p.skirt = c(0.20, 0.23, 0.19)
